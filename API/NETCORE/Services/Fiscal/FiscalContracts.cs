 ...
 *
 * A implementação atual é ZeusFiscalProvider (Hercules.NET.NFe.NFCe, in-process). Nada fora
 * desta pasta deve referenciar tipos da biblioteca — se um dia trocarmos por um gateway SaaS,
 * só muda o registro no Program.cs.
 */
