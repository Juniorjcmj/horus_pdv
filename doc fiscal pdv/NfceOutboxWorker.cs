 ...
 *
 * Por que existe: a API do ZeusFiscal é síncrona e uma chamada à SEFAZ pode levar
 * dezenas de segundos. Emitir dentro do request bloqueia thread do pool e derruba
 * a frente de caixa junto com a SEFAZ. Aqui, a venda é gravada e liberada na hora;
 * a nota é transmitida em seguida.
 *
 * Contingência offline (tpEmis=9): a NFC-e é emitida localmente, o DANFE sai com a
 * tarja de contingência e o XML é transmitido quando o serviço voltar. O prazo de
 * transmissão é de 24h. Por isso a fila vive no banco, não em memória — reinício de
 * processo não pode perder documento.
 */
