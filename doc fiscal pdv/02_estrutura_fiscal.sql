 ...
 * Pré-requisito: 01_migracao_valores.sql aplicado.
 *
...
BEGIN
    ...
    -- Certificado digital A1 (.pfx). Bytes e senha cifrados em repouso.
    ALTER TABLE Empresas ADD CertificadoPfx        VARBINARY(MAX)  NULL;
