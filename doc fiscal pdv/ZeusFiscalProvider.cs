 ...
 * Objetivo: implementa IFiscalProvider usando a biblioteca ZeusFiscal (DFe.NET) in-process,
 *           montando, assinando e transmitindo a NFC-e modelo 65 para a SVRS.
 * Entradas esperadas: recebe EmissaoNfceRequest já validado e o certificado A1 do emitente.
 *
 * Notas de operação:
 *  - A API do ZeusFiscal é SÍNCRONA. Todos os métodos aqui rodam sob Task.Run e só
 *    devem ser chamados pelo NfceOutboxWorker, nunca na thread de requisição.
 ...
 *  - DiretorioSchemas precisa acompanhar o deploy e ser atualizado a cada Nota Técnica.
 */
