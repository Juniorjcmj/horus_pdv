...
- Name: E-sales-multi-item.spec.ts >> E — Vendas multi-item >> E01 — Venda com múltiplos itens e totalização correta
- Location: tests\homologation\E-sales-multi-item.spec.ts:66:3
