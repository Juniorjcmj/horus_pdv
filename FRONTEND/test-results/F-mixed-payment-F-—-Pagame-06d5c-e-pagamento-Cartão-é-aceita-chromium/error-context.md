...
- Name: F-mixed-payment.spec.ts >> F — Pagamento misto >> F01 — Venda com forma de pagamento Cartão é aceita
- Location: tests\homologation\F-mixed-payment.spec.ts:61:3
